...
declare module Backbone {
    ...
    class Collection<TModel extends Model> extends ModelBase {
        ...
        **/
        ...
        add(array: any[]);  //when you add a collection of models by only defining their attributes
   ...
   interface ViewOptions<TModel extends Model> {
    ...
    class View<TModel extends Model> extends Events {
        ...
        **/
        ...
        //className: string; //I want to set it as a function if I like to
        className(): string;//string; //I want to set it as a function if I like to
        //tagName: string; //I want to set it as a function if I like to
        tagName(): string;
