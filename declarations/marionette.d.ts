...
//never forget to set these the backbone dependency in every project in order to work as it should:
...
declare module Marionette {
    ...
    class Region extends Marionette.Object {
         ...
         */
        el: any;
        //the element above only wrapped as jquery
        $el: JQuery;
        ...
        currentView: any;//Marionette.View<T>
    }
    ...
    class View<TModel extends Backbone.Model> extends Backbone.View<TModel> {
         ...
         */
        //ui: any;
        ui(): any;  //I have changed it from a property to a method in order to work
    ...
    class LayoutView<TModel extends Backbone.Model> extends ItemView<TModel> {
         ...
         * @param view this should be an ItemView or something more
         */
        showChildView(regionName: string, view: any): any;
