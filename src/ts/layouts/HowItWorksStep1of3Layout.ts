...
module Pligor {
    ...
    export class HowItWorksStep1of3Layout extends Marionette.LayoutView<Backbone.Model> {

        template = "script#how_it_works_step1of3_template" //http://marionettejs.com/docs/v2.4.1/marionette.itemview.html
