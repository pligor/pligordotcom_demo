...
module Pligor {
    ...
    export class TestimonialsItemView extends Marionette.ItemView<Backbone.Model> {

        template = "script#testimonials_template" //http://marionettejs.com/docs/v2.4.1/marionette.itemview.html
